...
public class OneToOneTests {
    ...
    void addAuthorWithAddress() {
        ...
        assertEquals("John Doe", savedAuthor.getFullName());
        assertEquals("123 Main St", savedAuthor.getAddress().getStreet());
        assertEquals("Springfield", savedAuthor.getAddress().getCity());
